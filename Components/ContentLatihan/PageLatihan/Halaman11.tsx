			...
			<div className="ps-lg-0">
				...
				<div className="subtitle mb-30">
					...
					<div className="main-content">
						<img src="/image/Pola/Pa.svg" className="img-fluid" alt="" />
					</div>
				</div>
			</div>
			<div className="button-nav">
				<Link href="/PageContent/LatihanAksara/HalamanLatihan/Halaman10">
					<a className="btn-left btn-get text-lg rounded-pill" role="button">
						Kembali
					</a>
				</Link>
				<Link href="/PageContent/LatihanAksara/HalamanLatihan/Halaman12">
